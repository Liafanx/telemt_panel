...
export function CountersPage() {
  ...
  return (
    <div className="w-full" data-testid="counters-detail">
      <DetailHeader title={s.details.pages.counters.title} description={v.description} status={sources.status} freshnessMs={sources.freshnessMs} nowMs={nowMs} onBack={() => void navigate({ to: "/pulse" })} />
